...
class JsonTable
{
     ...
     * 设置JsonTable数据
     *
     * @param integer|array $state 状态码
     * @param string $msg 消息体
     * @param mix $data 数据体
     * @return JsonTable 返回自身
     */
    protected function setData($state = 0, $msg = 'success', $data = null): JsonTable
    {
        $this->clear();
        $this->data = [
            'state' => intval($state),
     ...
     * @return JsonTable
     */
    public function setByArray(array $data): JsonTable
    {
        $this->clear();
     ...
     */
    public function success($msg = 'success', $data = null): JsonTable
    {
     ...
     */
    public function withSuccess($msg = 'success', $data = null): JsonTable
    {
     ...
     * @return JsonTable
     */
    public function successByData($data): JsonTable
    {
     ...
     * @return JsonTable
     */
    public function withSuccessByData($data): JsonTable
    {
     ...
     * @return JsonTable 返回克隆后的全新JsonTable对象
     */
    public function withError($msg = 'error', $state = 1, $data = null): JsonTable
    {
     ...
     * @return JsonTable 返回当前对象
     */
    public function error($msg = 'error', $state = 1, $data = null): JsonTable
    {
     ...
     * @return JsonTable 返回克隆后的全新JsonTable对象
     */
    public function withMessage($msg, $state = 0, $data = null): JsonTable
    {
        return clone $this->setData($state, $msg, $data);
    }
    /**
     ...
     * @return JsonTable 返回当前对象
     */
    public function message($msg, $state = 0, $data = null): JsonTable
    {
